...
STRINGS = {
    "az": {
        ...
        "btn.daily": "Gündəlik", "btn.daily_bonus": "Gündəlik Bonus", "btn.maps": "Xəritələr", "btn.record": "Rekord",
        "btn.squad": "Squad", "btn.share": "Paylaş", "btn.chart": "Qrafik",
        "btn.title": "Ləqəb", "btn.lang": "Dil", "btn.quests": "Questlər", "btn.synergy": "Sinergiya",
        "btn.pass": "Pass", "btn.convert": "Çevir", "btn.career": "Karyera",
        "btn.heatmap": "Fəallıq", "btn.coach": "AI Koç", "btn.notifications": "Bildirişlər", "btn.social": "Sosial", "btn.more": "Digər",
        "btn.stats_5v5": "5v5 Statistika",
        "btn.nickname": "Ad Dəyiş",
        "btn.menu_stats": "Statistika", "btn.menu_inventory": "İnventar", "btn.menu_rewards": "Mükafatlar",
        "btn.menu_social": "Sosial", "btn.menu_settings": "Ayarlar",
    ...
    "en": {
        ...
        "btn.daily": "Daily", "btn.daily_bonus": "Daily Bonus", "btn.maps": "Maps", "btn.record": "Record",
        "btn.squad": "Squad", "btn.share": "Share", "btn.chart": "Chart",
        "btn.title": "Title", "btn.lang": "Language", "btn.quests": "Quests", "btn.synergy": "Synergy",
        "btn.pass": "Pass", "btn.convert": "Convert", "btn.career": "Career",
        "btn.heatmap": "Activity", "btn.coach": "AI Coach", "btn.notifications": "Notifications", "btn.social": "Social", "btn.more": "More",
        "btn.stats_5v5": "5v5 Stats",
        "btn.nickname": "Change Nick",
        "btn.menu_stats": "Stats", "btn.menu_inventory": "Inventory", "btn.menu_rewards": "Rewards",
        "btn.menu_social": "Social", "btn.menu_settings": "Settings",
    ...
    "ru": {
        ...
        "btn.daily": "Ежедневно", "btn.daily_bonus": "Ежедневный бонус", "btn.maps": "Карты", "btn.record": "Рекорд",
        ...
        "btn.pass": "Пропуск", "btn.convert": "Обмен", "btn.career": "Карьера",
        "btn.heatmap": "Активность", "btn.coach": "AI Тренер", "btn.notifications": "Уведомления", "btn.social": "Соцактивность", "btn.more": "Ещё",
        "btn.stats_5v5": "Статистика 5v5",
        "btn.nickname": "Сменить ник",
        "btn.menu_stats": "Статистика", "btn.menu_inventory": "Инвентарь", "btn.menu_rewards": "Награды",
        "btn.menu_social": "Социальное", "btn.menu_settings": "Настройки",
