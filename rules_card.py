...
def generate_rules_card(sections, output_path="rules_card.png"):
    ...
    draw.text((pad_x, 28), "Nextlevelaz", font=brand_font, fill=GOLD)
    ...
    draw.text((pad_x, footer_y + 16), "Nextlevelaz  ·  FACEIT Rules", font=sub_font, fill=GRAY)
...
def generate_register_banner(logo_path=None, output_path="register_banner.png"):
    ...
    draw.text((36, 28), "Nextlevelaz", font=brand_font, fill=GOLD)
